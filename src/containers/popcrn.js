...
export default class Popcrn extends Component {
  constructor(props) {
    super(props);
  ...
  getToken(accesscode) {
    ...
    let authdata = {
      ...
      client_id: config.popcrnClientId,
      code: accesscode,
      redirect_uri: config.popcrnCallBackURL,
    };

    axios
      .post(
        config.popcrnDomain + "oauth2/token",
