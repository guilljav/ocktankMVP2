...
import Popcrn from './containers/popcrn';
import Lvrg from './containers/lvrg';
...
export default ({ childProps }) =>
  <Switch>
    ...
    <UnauthenticatedRoute path="/popcrn" exact component={Popcrn} props={childProps} />
    <UnauthenticatedRoute path="/lvrg" exact component={Lvrg} props={childProps} />
    ...
    <AppliedRoute path="/bronce" exact component={Bronce} props={childProps} />
